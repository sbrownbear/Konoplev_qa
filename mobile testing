...
https://software-testing.ru/images/stories/library/checklist-mobile-app-testen.pdf
Эмуляция – это воспроизведение работы программы или системы (а не какой-то её мизерной части) с сохранением её свойств и принципов работы. Эмуляция выполняет программный код в привычной для этого кода среде, состоящий из тех же компонентов, что и эмулируемый объект.
...
Тонкий клиент большую часть расчетов осуществляет на сервере. Толстый использует рабочее пользовательское место.
Виды мобильных приложений:
1. Веб-приложения используют клиент-серверную архитектуру и адаптированы под мобильные устройства. Веб-приложения не нужно устанавливать. Чтобы запустить веб-приложение на мобильном устройстве нужны: браузер, URL приложения и активное интернет - соединение.
2. Нативные приложения нужно устанавливать: сначала нужно скачать установочный файл. Приложения пишут на «родном» для устройства языке программирования. У Android – это Java и Kotlin, у IOS – Swift и Objective-C. Нативные приложения более производительны: они задействуют процессор и оперативную память мобильного устройства. Или применяют инструменты мобильного устройства – например, камеру, GPS, компас.
3. Гибридные приложения комбинируют свойства двух предыдущих: в основе «гибрида» - нативное приложение, его пишут отдельно под каждую платформу. Веб-содержание наполняют HTML, CSS, JS – они могут быть едины для всех платформ.
Так же, как и нативные приложения, гибридные устанавливаются через специальный файл. Чтобы оно работало, в большинстве случаев нужен постоянный доступ к интернету.
